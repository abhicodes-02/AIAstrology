        ...
        >
          <div>
            <div className="flex flex-wrap items-center gap-3 mb-4">
              ...
              <div className="flex items-center gap-1.5 bg-cyan-950/40 p-1 rounded-full border border-cyan-500/20 backdrop-blur-md">
                <Link
                  href={`/kp-daily-insight?${queryParams}&date=${prevDateIso}`}
                  className="p-1.5 rounded-full hover:bg-cyan-500/20 text-cyan-300 transition-colors"
                  title="Previous Day"
                >
                  <ChevronLeft className="w-3.5 h-3.5" />
                </Link>
                <div className="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-wider text-cyan-200 px-2.5 py-1">
                  <Calendar className="w-3.5 h-3.5 text-cyan-400" />
                  {dailyData.dateFormatted}
                </div>
                <Link
                  href={`/kp-daily-insight?${queryParams}&date=${nextDateIso}`}
                  className="p-1.5 rounded-full hover:bg-cyan-500/20 text-cyan-300 transition-colors"
                  title="Next Day"
                >
                ...
                <Link
                  href={`/kp-daily-insight?${queryParams}`}
                  className="text-[11px] font-bold uppercase tracking-wider bg-cyan-500/20 hover:bg-cyan-500/30 text-cyan-300 px-2.5 py-1 rounded-full border border-cyan-500/30 transition-all ml-1"
